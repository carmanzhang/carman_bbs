    ...
    <div class="index__bottom">
        <div class="wrapper">
            <div class="fn-flex-1">
                <div class="metro-line fn-flex">
                    <div class="metro-item">
                        <a class="preview" href="${servePath}/tag/${tag0.tagURI}">
                                                              <#--${tag0.tagIconPath}-->
                            <img src="${staticServePath}/images/tags/carman0.png" alt="${tag0.tagTitle}">
                                                              <#--${tag0.tagTitle}-->
                            <b>李若彤1</b>
                        </a>
                    </div>
                    <div class="metro-item">
                        ...
                        <#--${tag1.tagIconPath}-->
                            <img src="${staticServePath}/images/tags/carman1.png" alt="${tag1.tagTitle}">
                        <#--${tag1.tagTitle}-->
                            <b>李若彤2</b>
                        </a>
                    </div>
                    <div class="metro-item">
                        ...
                        <#--${tag2.tagIconPath}-->
                            <img src="${staticServePath}/images/tags/carman2.png" alt="${tag2.tagTitle}">
                        <#--${tag2.tagTitle}-->
                            <b>李若彤3</b>
                        </a>
                    </div>
                    <div class="metro-item">
                        ...
                        <#--${tag3.tagIconPath}-->
                            <img src="${staticServePath}/images/tags/carman3.png" alt="${tag3.tagTitle}">
                        <#--${tag3.tagTitle}-->
                            <b>李若彤4</b>
                        </a>
                    </div>
                    <div class="metro-item">
                        ...
                        <#--${tag4.tagIconPath}-->
                            <img src="${staticServePath}/images/tags/carman4.png" alt="${tag4.tagTitle}">
                        <#--${tag4.tagTitle}-->
                            <b>李若彤5</b>
                        </a>
                    </div>
                ...
                <#--</div>-->
                <#--<div class="metro-line fn-flex">-->
                    <#--&lt;#&ndash;<div class="metro-item">&ndash;&gt;-->
                        <#--&lt;#&ndash;<a class="preview" href="${servePath}/tag/${tag10.tagURI}">&ndash;&gt;-->
                            <#--&lt;#&ndash;<img src="${staticServePath}/images/tags/${tag10.tagIconPath}" alt="${tag10.tagTitle}">&ndash;&gt;-->
                            <#--&lt;#&ndash;<b>${tag10.tagTitle}</b>&ndash;&gt;-->
                        <#--&lt;#&ndash;</a>&ndash;&gt;-->
                    <#--&lt;#&ndash;</div>&ndash;&gt;-->
                    <#--&lt;#&ndash;<div class="metro-item">&ndash;&gt;-->
                        <#--&lt;#&ndash;<a class="preview" href="${servePath}/tag/${tag11.tagURI}">&ndash;&gt;-->
                            <#--&lt;#&ndash;<img src="${staticServePath}/images/tags/${tag11.tagIconPath}" alt="${tag11.tagTitle}">&ndash;&gt;-->
                            <#--&lt;#&ndash;<b>${tag11.tagTitle}</b>&ndash;&gt;-->
                        <#--&lt;#&ndash;</a>&ndash;&gt;-->
                    <#--&lt;#&ndash;</div>&ndash;&gt;-->
                    <#--<div class="metro-item">-->
